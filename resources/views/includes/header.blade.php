            ...
            <div id="sidebar-menu">
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('payments.create')}}">Əsas Ödəniş yarat</a></li>
                            <li><a href="{{route('payments.index')}}">Əsas ödənişlər</a></li>
                        </ul>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('vats.create')}}">ƏDV Ödəniş yarat</a></li>
                            <li><a href="{{route('vats.index')}}">ƏDV ödənişlər</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="ri-layout-3-line"></i>
                            <span>Görüşlər və Təkliflər</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('meetings.create')}}">Görüşlər və Təklif yarat</a></li>
                            <li><a href="{{route('meetings.index')}}">Görüşlər və Təkliflər</a></li>
                        </ul>
                    </li>
