                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="meeting_progress">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="price_offer">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="file" name="service_offer_file">
