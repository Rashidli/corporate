                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="voen" name="voen" value="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="payment_main">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="date" name="payment_date_main">
